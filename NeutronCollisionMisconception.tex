...
\section{Explanation}
	...
	*Insert Figure 3
	...
	This will give an incorrect answer because the average $E_f$ as determined by the rectangular area is different from the average as determined by the area under the curve $ \Delta u P(E)$ (which is the product of the two curves).
